package com.bank.bian.correspondentbankmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Correspondent Arrangement Management Plan".
 *
 ...
 * to its asset type (Correspondent Arrangement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Correspondent Arrangement Management Plan";
